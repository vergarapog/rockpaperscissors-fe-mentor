...
const PlayIcon = ({ icon, coordinates, gradient, entranceMode }) => {
  ...
  return (
    <div
      className={`absolute ${coordinates} w-28 h-28 lg:w-44 lg:h-44 bg-white rounded-full flex justify-center items-center 
    ...
    >
      <div
        className={`bg-white w-[5.5rem] h-[5.5rem] lg:w-[8rem] lg:h-[8rem] flex justify-center items-center rounded-full transition-all duration-500 
